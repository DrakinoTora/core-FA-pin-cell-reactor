...
$PDS_DIR/MICREF     S        C
************************************************************************
67 40  2 1 /  107 group => 3 (=2+1) group
67(1)      /  Energy group structure suggested for LWR analyses
40(1)      /
20 47   / Fast 3 group
40    / Thermal 3 group
...
4 / NMAT
FUELX01X  0 5  1073.15  0.784    0.0  / 1 : UO2 Fuel
...
CLADX03X  0 25  593.15  0.114     0.0  / 3 : Cladding Zirconium-Alloy
...
MODEX04X  0 2  573.15  0.458      0.0  / 4 : Moderator Water
